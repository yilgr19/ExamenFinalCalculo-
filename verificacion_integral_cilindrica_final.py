...
def calcular_integral_cilindrica():
    ...
    # Paso 2: Integral respecto a theta
    ...
    print(f"Componente r ((r_max^4 - r_min^4) / 4): {r_component}")
    
    # Cálculo final según método de la otra IA
    ...
    def integrar_simpson_3d(f, x_min, x_max, y_min, y_max, z_min, z_max, nx=100, ny=100, nz=100):
    ...
    print(f"Resultado numérico (integracion Simpson): {resultado_numerico}")
    
    # Comparación de resultados
    print("\n--- Comparación de Resultados ---")
    print(f"Método Simbólico: {resultado_numerico_simbolico}")
    print(f"Método Manual (otra IA): {float(resultado_manual)}")
